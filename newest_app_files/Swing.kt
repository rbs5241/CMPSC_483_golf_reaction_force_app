...
class Swing(private var forceView: ForceView, imageView: ImageView) {
    ...
    private val sw4FrontFrame1: HashMap<String, Double> = hashMapOf("leftX" to 403.60938, "leftY" to 666.9884973, "rightX" to 489.69558, "rightY" to 663.9133245)
    private val sw4FrontFrame2: HashMap<String, Double> = hashMapOf("leftX" to 460.3741527, "leftY" to 545.2661964, "rightX" to 556.30849, "rightY" to 772.0259927)
    private val sw4FrontFrame3: HashMap<String, Double> = hashMapOf("leftX" to 459.9356082, "leftY" to 554.4063773, "rightX" to 578.3204082, "rightY" to 821.6139773)
    private val sw4FrontFrame4: HashMap<String, Double> = hashMapOf("leftX" to 483.1427973, "leftY" to 624.4238282, "rightX" to 618.2107318, "rightY" to 823.7485436)
    private val sw4FrontFrame5: HashMap<String, Double> = hashMapOf("leftX" to 495.9087236, "leftY" to 585.4331555, "rightX" to 510.5346818, "rightY" to 245.0886118)
    private val sw4FrontFrame6: HashMap<String, Double> = hashMapOf("leftX" to 401.3407655, "leftY" to 813.6020873, "rightX" to 433.3239745, "rightY" to 178.4925982)
    private val sw4FrontFrame7: HashMap<String, Double> = hashMapOf("leftX" to 453.60938, "leftY" to 895.0579073, "rightX" to 529.1250055, "rightY" to 560.5403555)
    ...
    private val sw4TopFrame1: HashMap<String, Double> = hashMapOf("leftX" to 503.61, "leftY" to 639.90, "rightX" to 539.70, "rightY" to 653.86)
    private val sw4TopFrame2: HashMap<String, Double> = hashMapOf("leftX" to 660.37, "leftY" to 632.71, "rightX" to 353.54, "rightY" to 662.81)
    private val sw4TopFrame3: HashMap<String, Double> = hashMapOf("leftX" to 509.94, "leftY" to 649.70, "rightX" to 578.32, "rightY" to 653.08)
    private val sw4TopFrame4: HashMap<String, Double> = hashMapOf("leftX" to 533.14, "leftY" to 688.30, "rightX" to 618.21, "rightY" to 637.63)
    private val sw4TopFrame5: HashMap<String, Double> = hashMapOf("leftX" to 545.91, "leftY" to 776.34, "rightX" to 510.53, "rightY" to 408.63)
    private val sw4TopFrame6: HashMap<String, Double> = hashMapOf("leftX" to 451.34, "leftY" to 718.07, "rightX" to 433.32, "rightY" to 594.77)
    private val sw4TopFrame7: HashMap<String, Double> = hashMapOf("leftX" to 416.68, "leftY" to 684.10, "rightX" to 529.13, "rightY" to 703.65)
    ...
    private val sw5FrontFrame1: HashMap<String, Double> = hashMapOf("leftX" to 403.60938, "leftY" to 666.9884973, "rightX" to 489.69558, "rightY" to 663.9133245)
    private val sw5FrontFrame2: HashMap<String, Double> = hashMapOf("leftX" to 460.3741527, "leftY" to 545.2661964, "rightX" to 556.30849, "rightY" to 772.0259927)
    private val sw5FrontFrame3: HashMap<String, Double> = hashMapOf("leftX" to 459.9356082, "leftY" to 554.4063773, "rightX" to 578.3204082, "rightY" to 821.6139773)
    private val sw5FrontFrame4: HashMap<String, Double> = hashMapOf("leftX" to 483.1427973, "leftY" to 624.4238282, "rightX" to 618.2107318, "rightY" to 823.7485436)
    private val sw5FrontFrame5: HashMap<String, Double> = hashMapOf("leftX" to 495.9087236, "leftY" to 585.4331555, "rightX" to 510.5346818, "rightY" to 245.0886118)
    private val sw5FrontFrame6: HashMap<String, Double> = hashMapOf("leftX" to 401.3407655, "leftY" to 813.6020873, "rightX" to 433.3239745, "rightY" to 178.4925982)
    private val sw5FrontFrame7: HashMap<String, Double> = hashMapOf("leftX" to 453.60938, "leftY" to 895.0579073, "rightX" to 529.1250055, "rightY" to 560.5403555)
    ...
    private val sw5TopFrame1: HashMap<String, Double> = hashMapOf("leftX" to 503.61, "leftY" to 639.90, "rightX" to 539.70, "rightY" to 653.86)
    private val sw5TopFrame2: HashMap<String, Double> = hashMapOf("leftX" to 660.37, "leftY" to 632.71, "rightX" to 353.54, "rightY" to 662.81)
    private val sw5TopFrame3: HashMap<String, Double> = hashMapOf("leftX" to 509.94, "leftY" to 649.70, "rightX" to 578.32, "rightY" to 653.08)
    private val sw5TopFrame4: HashMap<String, Double> = hashMapOf("leftX" to 533.14, "leftY" to 688.30, "rightX" to 618.21, "rightY" to 637.63)
    private val sw5TopFrame5: HashMap<String, Double> = hashMapOf("leftX" to 545.91, "leftY" to 776.34, "rightX" to 510.53, "rightY" to 408.63)
    private val sw5TopFrame6: HashMap<String, Double> = hashMapOf("leftX" to 451.34, "leftY" to 718.07, "rightX" to 433.32, "rightY" to 594.77)
    private val sw5TopFrame7: HashMap<String, Double> = hashMapOf("leftX" to 416.68, "leftY" to 684.10, "rightX" to 529.13, "rightY" to 703.65)
    ...
    private val sw6FrontFrame1: HashMap<String, Double> = hashMapOf("leftX" to 403.60938, "leftY" to 666.9884973, "rightX" to 489.69558, "rightY" to 663.9133245)
    private val sw6FrontFrame2: HashMap<String, Double> = hashMapOf("leftX" to 460.3741527, "leftY" to 545.2661964, "rightX" to 556.30849, "rightY" to 772.0259927)
    private val sw6FrontFrame3: HashMap<String, Double> = hashMapOf("leftX" to 459.9356082, "leftY" to 554.4063773, "rightX" to 578.3204082, "rightY" to 821.6139773)
    private val sw6FrontFrame4: HashMap<String, Double> = hashMapOf("leftX" to 483.1427973, "leftY" to 624.4238282, "rightX" to 618.2107318, "rightY" to 823.7485436)
    private val sw6FrontFrame5: HashMap<String, Double> = hashMapOf("leftX" to 495.9087236, "leftY" to 585.4331555, "rightX" to 510.5346818, "rightY" to 245.0886118)
    private val sw6FrontFrame6: HashMap<String, Double> = hashMapOf("leftX" to 401.3407655, "leftY" to 813.6020873, "rightX" to 433.3239745, "rightY" to 178.4925982)
    private val sw6FrontFrame7: HashMap<String, Double> = hashMapOf("leftX" to 453.60938, "leftY" to 895.0579073, "rightX" to 529.1250055, "rightY" to 560.5403555)
    ...
    private val sw6TopFrame1: HashMap<String, Double> = hashMapOf("leftX" to 503.61, "leftY" to 639.90, "rightX" to 539.70, "rightY" to 653.86)
    private val sw6TopFrame2: HashMap<String, Double> = hashMapOf("leftX" to 660.37, "leftY" to 632.71, "rightX" to 353.54, "rightY" to 662.81)
    private val sw6TopFrame3: HashMap<String, Double> = hashMapOf("leftX" to 509.94, "leftY" to 649.70, "rightX" to 578.32, "rightY" to 653.08)
    private val sw6TopFrame4: HashMap<String, Double> = hashMapOf("leftX" to 533.14, "leftY" to 688.30, "rightX" to 618.21, "rightY" to 637.63)
    private val sw6TopFrame5: HashMap<String, Double> = hashMapOf("leftX" to 545.91, "leftY" to 776.34, "rightX" to 510.53, "rightY" to 408.63)
    private val sw6TopFrame6: HashMap<String, Double> = hashMapOf("leftX" to 451.34, "leftY" to 718.07, "rightX" to 433.32, "rightY" to 594.77)
    private val sw6TopFrame7: HashMap<String, Double> = hashMapOf("leftX" to 416.68, "leftY" to 684.10, "rightX" to 529.13, "rightY" to 703.65)
